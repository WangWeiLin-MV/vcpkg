...
#[[
    ...
    # 
    # @global {string}      z_vcpkg_vgpph_components_schema_prefix
    # @global {string[]}    z_vcpkg_vgpph_components_schema_columns
    # 
    ...
    #
    # @reset {integer}      z_vcpkg_vgpph_components_schema_auto_increment
    # @reset {integer[]}    z_vcpkg_vgpph_components_column_id
    # @reset {string[]}     z_vcpkg_vgpph_components_column_compatibility
    # @reset {string[]}     z_vcpkg_vgpph_components_column_get_virtualenv
    # @reset {string[]}     z_vcpkg_vgpph_components_column_get_pip
    # @reset {string[]}     z_vcpkg_vgpph_components_column_precandidate_diff
    # @reset {string[]}     z_vcpkg_vgpph_components_column_pip
    # @reset {string[]}     z_vcpkg_vgpph_components_column_setuptools
    # @reset {string[]}     z_vcpkg_vgpph_components_column_wheel
]]#
function(z_vcpkg_vgpph_initialize_bootstrap_components_new_record)
    set(_options "")
    set(_single "${z_vcpkg_vgpph_components_schema_columns}")
    set(_multi "")
    cmake_parse_arguments(PARSE_ARGV 0 arg "${_options}" "${_single}" "${_multi}") # arg_UNPARSED_ARGUMENTS

    list(LENGTH arg__column_id _list_length)
    if(_list_length EQUAL 0)
        set(arg__column_id "${z_vcpkg_vgpph_components_schema_auto_increment}")
        math(EXPR z_vcpkg_vgpph_components_schema_auto_increment "${z_vcpkg_vgpph_components_schema_auto_increment} + 1")
    elseif(_list_length EQUAL 1)
        ...
        if(arg__column_id GREATER_EQUAL z_vcpkg_vgpph_components_schema_auto_increment)
            math(EXPR z_vcpkg_vgpph_components_schema_auto_increment "${arg__column_id} + 1")
        endif()
    endif()

    if(arg__column_id IN_LIST z_vcpkg_vgpph_components_column_id)
    ...
    return(PROPAGATE z_vcpkg_vgpph_components_schema_auto_increment)
...
function(z_vcpkg_vgpph_initialize_bootstrap_components_table)
    ...
    set(z_vcpkg_vgpph_components_compatibility_intervals "[2.7,2.8);[3.7)")
    set(z_vcpkg_vgpph_components_compatibility_map_intervals "[2.7,2.8);[3.7,3.8),[3.8,)")
    set(z_vcpkg_vgpph_components_compatibility_map_ids "207,307")
...
function(z_vcpkg_vgpph_initialize_bootstrap_components_find COMPATIBLE_VERSION)
    set(_options "")
    set(_single "CALLBACK_CODE")
    set(_multi "")
    cmake_parse_arguments(PARSE_ARGV 1 arg "${_options}" "${_single}" "${_multi}") # arg_UNPARSED_ARGUMENTS
...
z_vcpkg_vgpph_initialize_bootstrap_components_find(1.2.3
    CALLBACK_CODE [[
        message(STATUS "==-==")
        cmake_print_variables(x)
        set(__c )
